    ...
    public class CatalogController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var listingResult = assetModels
                .Select(a => new AssetIndexListingModel
                {
                    ...
                    DeweyCallNumeber = _assetsService.GetDeweyIndex(a.Id),
            ...
            //ViewBag.Stuff = _configuration["SecretName"];
            //ViewBag.Stuffs = _configuration["az-login-sql"];
            return View(model);
        }
        ...
        public IActionResult Detail(int id)
        {
            ...
            var model = new AssetDetailModel
            {
                ...
                LibraryCardCurrent = _assetsService.GetLibraryCardByAssetId(id),
